...
personal_task::personal_task(std::string name, std::string description, const PRIORITY priority,
                             const STATUS status): task(std::move(name), std::move(description), priority, status) {
}
